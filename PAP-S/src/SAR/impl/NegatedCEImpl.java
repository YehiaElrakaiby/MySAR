...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Negated CE</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link SAR.impl.NegatedCEImpl#getOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NegatedCEImpl extends ConditionExpressionImpl implements NegatedCE {
	/**
	...
	protected EClass eStaticClass() {
		return SARPackage.Literals.NEGATED_CE;
	}
	...
	public NotificationChain basicSetOp(ConditionExpression newOp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SARPackage.NEGATED_CE__OP, oldOp, newOp);
	...
	public void setOp(ConditionExpression newOp) {
		if (newOp != op) {
			...
			if (op != null)
				msgs = ((InternalEObject)op).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SARPackage.NEGATED_CE__OP, null, msgs);
			if (newOp != null)
				msgs = ((InternalEObject)newOp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SARPackage.NEGATED_CE__OP, null, msgs);
			msgs = basicSetOp(newOp, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SARPackage.NEGATED_CE__OP, newOp, newOp));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SARPackage.NEGATED_CE__OP:
