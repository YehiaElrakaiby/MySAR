 ...
 * <!-- end-user-doc -->
 * @see SAR.SARPackage#getExecutionType()
 * @model
 * @generated
 */
public enum ExecutionType implements Enumerator {
	 ...
	 * @ordered
	 */
	MANDATORY(0, "Mandatory", "must_execute"),
	 ...
	 * <!-- end-user-doc -->
	 * @see #MANDATORY
	 * @model name="Mandatory" literal="must_execute"
	 * @generated
	 * @ordered
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @see #OPTIONAL
	 * @model name="Optional" literal="execute"
	 * @generated
	 * @ordered
	 */
