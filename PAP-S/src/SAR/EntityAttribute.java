 ...
 * </p>
 * <ul>
 *   <li>{@link SAR.EntityAttribute#getField_type <em>Field type</em>}</li>
 * </ul>
 *
 * @see SAR.SARPackage#getEntityAttribute()
 * @model
 * @generated
 */
public interface EntityAttribute extends AttributeDeclaration {
	/**
	 ...
	 * @see SAR.SARPackage#getEntityAttribute_Field_type()
	...
	/**
	 * Sets the value of the '{@link SAR.EntityAttribute#getField_type <em>Field type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	String toPrologMeta(String id);

	void getPIPAttribute(String id, HashMap<String, String> map);

	boolean isPIPAttribute();
